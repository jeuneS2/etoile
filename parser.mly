...
task_spec_line: TASK STRING INT INT INT deadline_spec INT {
      task_id := !task_id + 1;
      { name = $2; period = $3; wcet = $4; offset = $5; deadline = $6;
        userfun = $2 ^ "_fun"; id = !task_id; size = $7 }
    }
    | TASK STRING DEF STRING INT INT INT deadline_spec INT {
      task_id := !task_id + 1;
      { name = $2; period = $5; wcet = $6; offset = $7; deadline = $8;
        userfun = $4; id = !task_id; size = $9 }
    }
